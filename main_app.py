...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        lbl_result = Label(text='Введите результат:', haligh='right')
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        line1 = BoxLayout(size_hint=(0.8, None), height='30sp')
        lbl_result1 = Label(text='Результат:', haligh='right')
        ...
        line2 = BoxLayout(size_hint=(0.8, None), height='30sp')
        lbl_result2 = Label(text='Результат после отдыха:', haligh='right')
...
class Result(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.outer = BoxLayout(size_hint=(0.8, None), height='30sp')
...
class HeartCheck(App):
    def build(self):
        sm = ScreenManager()
        sm.add_widget(InsrtScr(name='instr'))
